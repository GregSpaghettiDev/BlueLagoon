...
internal static class Extensions
{
    ...
    public static void ConfigureIamPolicies(this AuthorizationOptions options)
    {
        ...
        options.AddPolicy(AuthorizationPolicies.ListModules, p => p.RequireAssertion(context => context.User.IsInRole(ValueObjects.Role.IamAdminRoleName) || context.User.HasClaim("permission", "iam.read-modules")));
