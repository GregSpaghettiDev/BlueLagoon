...
public sealed class InvalidScopeException(int minCharactersNumber) 
    : BaseIamCoreException($"Niepoprawna nazwa aplikacji. Nazwa aplikacji musi zawierać minimum {NounsGradator.GradateTheNounAccordingToQuantity(minCharactersNumber, "znak", "znaki", "znaków")}.", "008")
{
