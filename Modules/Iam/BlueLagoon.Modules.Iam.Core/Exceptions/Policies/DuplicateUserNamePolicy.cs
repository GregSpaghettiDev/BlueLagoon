...
internal sealed class DuplicateUserNamePolicy : IIdentityErrorPolicy
{
    ...
    {
        var exception = new UserAlreadyExistsException(identityError.Code, identityError.Description);
